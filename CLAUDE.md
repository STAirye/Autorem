...
Repo git ya inicializado (rama `main`, fuera de OneDrive). Versión **1.6.0**
...
header y se bumpean juntos. La GUI la muestra en el título. Estado actual: **1.6.0**.
...
|---|---|---|
| **Salud Mental** | A05 egresos · A05 ingresos · A03 D.3 screening · **Actividades (A04·A06·A19a·A26·A27·A32)** · **Trabajo perdido (saco vacío)** | ✅ |
