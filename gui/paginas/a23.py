...
instrucciones = (
    ("Tabula el REM A23 (Respiratorio) por paciente. Todos los inputs tienen PII -> quedan LOCALES.\n"
     ...
     "        hace >1 año, así que sin el año previo la Sección G no funciona (te avisa).\n"
     "3.  Estratificación de Riesgo (opcional)  ->  mejora la detección de asma/EPOC/FQ/SBOR.\n"
     "4.  Pacientes Inasistentes  (opcional)  ->  Sección H: citas Control/Ingreso IRA/ERA no asistidas.\n"
     ...
     "    y el Monitoreo trae los diagnósticos sin código (Ira Alta, Bronquitis y EPOC exacerbado salen en 0).\n"
