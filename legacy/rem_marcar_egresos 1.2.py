...
# -*- coding: utf-8 -*-
# ==========================================================================
# This code was generated with the assistance of Claude Fable 5 (Anthropic).
...
USO:
  ...
  - Terminal (modo experto):  python rem_marcar_egresos.py --cli entrada.xlsx [salida.xlsx]
...
# openpyxl es la única dependencia real. En el .exe va empaquetado; corriendo
# como .py suelto puede faltar -> avisamos con instrucciones.
try:
    import openpyxl
    OPENPYXL_OK = True
    OPENPYXL_ERR = ""
...
class ArchivoInvalido(Exception):
    """El archivo no es un export IRIS 'Control de Salud Mental' válido."""
    def __init__(self, categoria, mensaje):
        self.categoria = categoria      # "administrativo" | "desconocido"
...
def abrir_carpeta(carpeta: Path):
    """Abre el explorador en la carpeta del resultado (multiplataforma)."""
    import subprocess
    try:
