...
- **Dato para quien investigue el `tk.tcl` intermitente:** en la verificación de la ronda 13
  salió una vez, y el test que cayó fue
  `test_gui_construccion.py::test_todas_las_paginas_se_construyen`. No reproduce: pasa solo
  (20 s) y la corrida completa siguiente dio 298 passed. No se capturó el traceback.
